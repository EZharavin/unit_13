...
function f6() {
    let inputIn61 = document.querySelector('.i-61').value;
    let inputIn62 = document.querySelector('.i-62').value;

    a6[inputIn61] = inputIn62;
...
function f7() {
    let inputIn7 = document.querySelector('.i-7').value;
    let out = '';
    for (let key in a7){
        //console.log(key);
        if (key == inputIn7){
...
function f8() {
    let inputIn8 = document.querySelector('.i-8').value;
...
function f9() {
    let inputIn9 = document.querySelector('.i-9').value;
...
function f11() {
    let inputIn11 = document.querySelector('.i-11').value;

    delete a11[inputIn11];
...
function f12() {
    let inputIn12 = document.querySelector('.i-12').value;

    delete a12[inputIn12];
